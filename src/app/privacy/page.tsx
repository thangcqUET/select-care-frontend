    ...
    <div className="min-h-screen bg-white py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <li>Selected text and related metadata only when you explicitly use the extension to save or act on a selection. This data is processed locally and only sent to our hosted web app when you choose to sync or sign in.</li>
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>Persist your login state and preferences across sessions.</li>
          <li>Provide syncing and export features to the hosted web app (when you sign in and consent).</li>
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li><strong>storage</strong>: store authentication token, user email, and lightweight preferences locally.</li>
          ...
          <li><strong>Host permission</strong> for <code>https://main.djfc0uq2bj5xw.amplifyapp.com/*</code>: used only to open the hosted web app for sign-in and optional syncing.</li>
        </ul>
